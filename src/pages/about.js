        ...
        <main class="min-h-screen flex flex-col justify-between bg-gray-100">
            <div>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <p class="mt-10 text-base sm:text-xl text-center sm:w-2/3">I love the feeling that I get upon submitting problems I've been working on for hours and seeing if they're finally work. My favorite phrase is "Sleep, code, eat, repeat", I sometimes really follow this rule to the letter, though don't take it too seriously. I have a <Lnk to="https://github.com/francoisvogel/cp" text="Github Repo"/> where I post resources on CP, though for now it's mostly empty (I'm in the process of migrating resources to it). I'm a <Lnk to="https://codeforces.com/profile/fvogel" text="Candidate Master" /> on Codeforces. Also, I regularly write posts on CP in my blog.</p>
